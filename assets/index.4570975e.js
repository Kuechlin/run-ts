...
`,dt=({items:e,active:t,onSelect:r})=>d.createElement(st,null,e.map((e=>d.createElement(ct,{active:e===t,onClick:()=>r&&r(e),key:e},d.createElement(R,null,e))))),mt=f.exports.lazy((()=>{return e=()=>import("./Editor.96605b31.js"),(t=["assets/Editor.96605b31.js","assets/vendor.834bd075.js"])&&0!==t.length?Promise.all(t.map((e=>{if((e=`/${e}`)in $)return;$[e]=!0;const t=e.endsWith(".css"),r=t?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${r}`))return;const o=document.createElement("link");return o.rel=t?"stylesheet":"modulepreload",t||(o.as="script",o.crossOrigin=""),o.href=e,document.head.appendChild(o),t?new Promise(((e,t)=>{o.addEventListener("load",e),o.addEventListener("error",t)})):void 0}))).then((()=>e())):e();var e,t}));function ut(){const e=le(),t=ne().theme,r=S(e.run,1e3,!0),o=f.exports.useCallback((e=>{!e.ctrlKey||"s"!==e.key&&"s"!==e.key||(e.preventDefault(),r())}),[]);return f.exports.useEffect((()=>(window.addEventListener("keydown",o),()=>{window.removeEventListener("keydown",o)})),[]),d.createElement(y,{theme:t},d.createElement(H,{onKeyDown:o,header:d.createElement(d.Fragment,null,d.createElement(pt,{onClick:r}),d.createElement(lt,null)),editor:d.createElement(f.exports.Suspense,{fallback:d.createElement(ue,null)},d.createElement(mt,null)),output:d.createElement(he,null)}))}const pt=({onClick:e})=>{const t=ne(),{colors:r}=x();return d.createElement(we,{style:{border:t.running?"1px solid "+r.link:void 0,transition:"0.5s",margin:"0px 8px"},onClick:e,icon:d.createElement(De,{size:16})},"strg + s")},gt=E(oe);globalThis.React=d,k.render(d.createElement(w,{value:gt},d.createElement(ut,null)),document.getElementById("root"));export{pe as P,ae as a,le as u};
