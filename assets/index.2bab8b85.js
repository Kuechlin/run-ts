...
`;function Se({open:e,title:t,children:r,onClose:o}){return d.createElement(Ce,{open:e,onClick:o},d.createElement(ze,{onClick:e=>e.stopPropagation()},t&&d.createElement(Le,{size:24},t),o&&d.createElement(Ne,{onClick:o},d.createElement(Ie,null)),r))}const Ce=c.div`
...
`,Ae=c(R)`
  width: 124px;
`,Ke=({color:e,onChange:t})=>{const[r,o]=f.exports.useState(!1),n=()=>o((e=>!e));return d.createElement(Re,null,d.createElement(Ee,{children:e,onClick:n}),d.createElement(He,{open:r},d.createElement(Ve,{onClick:n}),d.createElement(y,{color:e,onChange:e=>t(e.hex)})))},Re=c.div`
  position: relative;
`,Ve=c.div`
  position: fixed;
  top: 0;
...
`;function Ge({value:e,onSearch:t,onSelect:r}){const[o,n]=f.exports.useState(!1),[l,a]=f.exports.useState(null),[i,s]=f.exports.useState(!1),[c,m]=f.exports.useState([]),u=f.exports.useCallback((async e=>{s(!0),a(e.target.value),m(await t(e.target.value)),s(!1)}),[]),p=f.exports.useCallback((e=>t=>{t.preventDefault(),t.stopPropagation(),a(null),r(e),n(!1)}),[]);return d.createElement(Ue,{onClick:e=>{n(!0)}},o&&d.createElement(Qe,{onClick:e=>{e.stopPropagation(),n(!1)}}),d.createElement(Xe,{open:o},d.createElement(Ze,{value:l||e,onChange:u}),i&&d.createElement(ue,null)),d.createElement(Ye,{open:o},0===c.length&&d.createElement(R,{style:{padding:"4px 8px",display:"block",color:"rgba(255,255,255,0.2)"}},"no data"),c.map(((e,t)=>d.createElement("button",{onClick:p(e.value)},d.createElement(R,null,e.label))))))}const Ue=c.div`
  min-width: 64px;
  display: flex;
  flex-direction: column;
  position: relative;
...
`,dt=({items:e,active:t,onSelect:r})=>d.createElement(st,null,e.map((e=>d.createElement(ct,{active:e===t,onClick:()=>r&&r(e),key:e},d.createElement(R,null,e))))),mt=f.exports.lazy((()=>{return e=()=>import("./Editor.dd4bfa64.js"),(t=["assets/Editor.dd4bfa64.js","assets/vendor.5f320342.js"])&&0!==t.length?Promise.all(t.map((e=>{if((e=`/run-ts/${e}`)in $)return;$[e]=!0;const t=e.endsWith(".css"),r=t?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${e}"]${r}`))return;const o=document.createElement("link");return o.rel=t?"stylesheet":"modulepreload",t||(o.as="script",o.crossOrigin=""),o.href=e,document.head.appendChild(o),t?new Promise(((e,t)=>{o.addEventListener("load",e),o.addEventListener("error",t)})):void 0}))).then((()=>e())):e();var e,t}));function ut(){const e=le(),t=ne(),r=ne().theme,o=S(e.run,1e3,!0),n=f.exports.useCallback((e=>{!e.ctrlKey||"s"!==e.key&&"s"!==e.key||(e.preventDefault(),o())}),[]);return f.exports.useEffect((()=>(window.addEventListener("keydown",n),()=>{window.removeEventListener("keydown",n)})),[]),d.createElement(v,{theme:r},d.createElement(H,{onKeyDown:n,header:d.createElement(d.Fragment,null,d.createElement(pt,{onClick:o}),d.createElement(lt,null)),editor:d.createElement(f.exports.Suspense,{fallback:d.createElement(ue,null)},d.createElement(mt,null)),output:t.error?d.createElement(gt,{error:t.error}):d.createElement(he,null)}))}const pt=({onClick:e})=>{const t=ne(),{colors:r}=x();return d.createElement(we,{style:{border:t.running?"1px solid "+r.link:void 0,transition:"0.5s",margin:"0px 8px"},onClick:e,icon:d.createElement(De,{size:16})},"strg + s")},gt=({error:e})=>d.createElement(ht,null,"string"==typeof e?e:e instanceof Error?e.message:JSON.stringify(e,null,2)),ht=c.pre`
  margin: 8px;
  color: ${e=>e.theme.colors.error};
`,ft=E(oe);globalThis.React=d,k.render(d.createElement(w,{value:ft},d.createElement(ut,null)),document.getElementById("root"));export{pe as P,ae as a,le as u};
